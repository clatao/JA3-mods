...
A collection of mods for [Jagged Alliance 3](https://www.thqnordic.com/games/jagged-alliance-3).

## Installation

1. Copy the mod folder to `%APPDATA%\Jagged Alliance 3\mods\<mod-folder>\`
2. Launch the game and open the Mod Manager
3. Enable the mod and restart if prompted
...
**Options** (configurable in-game under Options → Mod Options):

| Option | Values | Default |
|---|---|---|
| Training Points Cap | 10 / 15 / 20 | 10 |

**Folder:** `LimitedTraining/`
